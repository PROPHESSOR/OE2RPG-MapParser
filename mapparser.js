...
class Parser {
    ...
    parse() {
        ...
        fs.writeFileSync(this.to, this.generate(map.lines, texmap, map.things, map.decals, map.bspheader, map.scripts, map.bytecode, postprocess));
    ...
    generate(lines, texmap, things, decals, bspheader, scripts, bytecode, postprocess) {

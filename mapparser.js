...
class Parser {
    ...
    parse() {
        ...
        fs.writeFileSync(this.to, this.generate(map.lines, texmap, map.things, map.decals, map.bspheader, preprocess));
    ...
    generate(lines, texmap, things, decals, bspheader, postprocess) {
